...
import (
	myFoo "github.com/kevinswiber/languageserver-go/lsp/foo" //@mark(myFoo, "myFoo"),godef("myFoo", myFoo)
	"github.com/kevinswiber/languageserver-go/lsp/godef/a"   //@mark(AImport, re"\".*\"")
)
