...
import (
	...
	"github.com/kevinswiber/languageserver-go/lsp/baz"
	_ "github.com/kevinswiber/languageserver-go/lsp/signature" // provide type information for unimported completions in the other file
)
